    ...
    <section className={styles.policy}>
      ...
      <div>
        ...
        <p>
          ...
          conditions. Do not continue to use KESA if you do not agree to take
        ...
        <h6>Cookies</h6>
        <p>
          Unless otherwise stated, KESA and/or its licensors own the
          ...
          this from KESA for your own personal use subjected to restrictions set
          in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from KESA</li>
          <li>Sell, rent or sub-license material from KESA</li>
          <li>Reproduce, duplicate or copy material from KESA</li>
          <li>Redistribute content from KESA</li>
        </ul>
        <p>
        ...
        <p>
          ...
          KESA does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of KESA,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, KESA shall not be liable for
        ...
        <p>
          KESA reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant KESA a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of KESA; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to KESA. Please include your name, your organization
        ...
        <p>
          No use of KESA&#39;s logo or other artwork will be allowed for linking
