  ...
  return (
    <section className={styles.policy}>
      ...
      <div>
        ...
        <p>Welcome to CountyCU!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of CountyCU&#39;s Website, located at https://CountyCUbank.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use CountyCU if you do not agree to
          take all of the terms and conditions stated on this page.
        </p>
        <p>
          The following terminology applies to these Terms and Conditions,
          Privacy Statement and Disclaimer Notice and all Agreements:
          &#34;Client&#34;, &#34;You&#34; and &#34;Your&#34; refers to you, the
        ...
        <h6>Cookies</h6>
        <p>
          Unless otherwise stated, CountyCU and/or its licensors own the
          intellectual property rights for all material on Somerset Credit
          Union. All intellectual property rights are reserved. You may access
          this from CountyCU for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from CountyCU</li>
          <li>Sell, rent or sub-license material from CountyCU</li>
          <li>Reproduce, duplicate or copy material from CountyCU</li>
          <li>Redistribute content from CountyCU</li>
        </ul>
        <p>
        ...
        <p>
          ...
          CountyCU does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of CountyCU,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, CountyCU shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          CountyCU reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant CountyCU a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of CountyCU; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to CountyCU. Please include your name, your
        ...
        <p>
          No use of CountyCU&#39;s logo or other artwork will be allowed for
