		...
		<section className={styles.policy}>
			...
			<div>
				...
				<p>
					...
					for the use of KESA&#39;s Website, located at
					https://cadencefcu.com.
				</p>
				<p>
					By accessing this website we assume you accept these terms
					and conditions. Do not continue to use KESA if you do not
				...
				<p>
					...
					intellectual property rights for all material on KESA. All
					intellectual property rights are reserved. You may access
					this from Cadence Credit Union for your own personal use
				...
				<ul>
					...
					<li>
						Sell, rent or sub-license material from Cadence Credit
						Union
					</li>
					<li>
						Reproduce, duplicate or copy material from Cadence
						Credit Union
					</li>
				...
				<p>
					...
					the website. KESA does not filter, edit, publish or review
					Comments prior to their presence on the website. Comments do
					not reflect the views and opinions of KESA,its agents and/or
					affiliates. Comments reflect the views and opinions of the
					person who post their views and opinions. To the extent
					permitted by applicable laws, KESA shall not be liable for
				...
				<p>
					KESA reserves the right to monitor all Comments and to
				...
				<p>
					You hereby grant KESA a non-exclusive license to use,
				...
				<p>
					...
					compensates the absence of KESA; and (d) the link is in the
				...
				<p>
					...
					inform us by sending an e-mail to KESA. Please include your
				...
				<p>
					No use of KESA&#39;s logo or other artwork will be allowed
